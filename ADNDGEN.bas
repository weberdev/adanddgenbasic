...
Rem IF RA = 2 AND ST > 8 AND CN > 6 AND DX > 8 AND IN > 8 THEN PRINT "ELF FMT"
Rem IF RA = 2 and ST > 8 AND CN > 6 AND DX > 5 AND IN > 8 THEN PRINT "ELF FM"
Rem IF RA = 2 AND IN > 8 AND DX > 8 THEN ELF MT
